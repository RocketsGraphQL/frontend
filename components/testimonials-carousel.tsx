      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">Platform as a service</div>
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Explore our developer resources</h2>
            <p className="text-lg text-slate-400">Rich collection of API documentation, blogs, customer support, video tutorials and more to get you started.</p>
          </div>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Postgres Policies</div>
                        <div className="text-slate-400 mb-3">Pre-defined Postgres policies and triggers. Attach with a single click.</div>
                      </div>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Easy Authentication</div>
                        <div className="text-slate-400 mb-3">Authenticate your users with a single line of code on production.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="https://youtu.be/K5TGDapSnQw" target="_blank">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
                    </div>
                  </div>
                </HighlighterItem>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">Email/Password, Social, Magic link and OTP</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="https://github.com/RocketsGraphQL/rgraph/tree/master/example-setups/social" target="_blank">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
                    </div>
                  </div>
                </HighlighterItem>
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Blog</div>
                        <div className="text-slate-400 mb-3">Explore our blog with examples on how to build great apps.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="https://blog.rocketgraph.io/" target="_blank">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
                    </div>
                  </div>
                </HighlighterItem>
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Documentation</div>
                        <div className="text-slate-400 mb-3">Robust documentation of API and video tutorials.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="https://docs.rocketgraph.io/" target="_blank">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
                    </div>
                  </div>
                </HighlighterItem>
