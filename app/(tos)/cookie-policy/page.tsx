...
export default function SignUp() {
  ...
  return (
    <>
<h1>Cookie Policy for Rocketgraph</h1>

<p>This is the Cookie Policy for Rocketgraph, accessible from https://rocketgraph.io/</p>
...
<ul>
<li>Email: kaushik@rocketgraph.io</li>
